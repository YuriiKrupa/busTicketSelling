...
class BusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus" do
    assert_difference('Bus.count') do
      post buses_url, params: { bus: { class: @bus.class, licence_number: @bus.licence_number, seats: @bus.seats } }
    end
  ...
  test "should update bus" do
    patch bus_url(@bus), params: { bus: { class: @bus.class, licence_number: @bus.licence_number, seats: @bus.seats } }
